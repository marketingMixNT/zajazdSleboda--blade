...
<div class="flex flex-col justify-between items-start">
    <img src="{{asset('/assets/images/dish/dish-2.jpeg')}}" alt="" class="w-full h-[60%] object-cover">

    <div class="mt-12 sm:mt-0 self-center sm:self-end flex flex-col justify-center sm:justify-end items-center sm:items-end gap-3 mb-12 sm:mb-24 lg:mb-12">
...
<div class="flex flex-col justify-start">
    <img src="{{asset('/assets/images/dish/dish-3.jpeg')}}" alt="" class="h-[80%] w-full object-cover mt-6"></div>
