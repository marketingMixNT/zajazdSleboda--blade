            ...
            <form action="{{ route('cookieconsent.accept.configuration') }}" method="post" class="cookies__customize">
                ...
                <div class="cookies__sections">
                    ...
                    <div class="cookies__section">
                        ...
                        <a href="#cookies-policy-{{ $category->key() }}" class="cookies__details" style='color:black'>@lang('cookieConsent::cookies.details.more')</a>
                    </div>
                    @endforeach
                </div>
                <div class="cookies__save">
                    <button type="submit" class="cookiesBtn__link" style='background-color:black;border:1px solid black'>@lang('cookieConsent::cookies.save')</button>
                </div>
            </form>
        </div>
    </div>
