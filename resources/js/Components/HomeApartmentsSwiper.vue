<template>
    ...
    >
                     ...
                     <swiper-slide v-for="apartment in apartments" :key="apartment.title"
                         class="">
...
console.log(props.apartments);
  ...
  .swiper-slide {
    @apply my-6 lg:my-16 mx-16 w-[280px] h-[430px] xs:w-[350px] xs:h-[550px] md:w-[530px] md:h-[530px] 2xl:w-[700px] 2xl:h-[700px] 
  }
